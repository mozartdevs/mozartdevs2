!(function () {
  ...
  var t = { FORM_ERROR: "form-error", SERVER_ERROR: "server-error" },
    n =
    ...
    s = (function () {
      ...
      function d(e) {
        (h = null), ("/" !== e && "" !== e && e !== v.BASE_URL) || (e = "home");
        for (var t in v)
      ...
      function u(e) {
        ...
        for (var n in v) v.hasOwnProperty(n) && e === v[n].name && (t = v[n]);
        return null === t && (t = v.PAGE_404), t;
      }
      function f() {
      ...
      function p() {
        (v = Config),
          ...
          (b.pageLoaded = !0);
        var e = BNS.isOn();
        e && BNS.off(), c.scrollTo(0), e && BNS.on(), o(), i();
      }
      var g,
        h,
        v,
    ...
    r = (function () {
      function e() {
        d.hasClass("on") &&
          p.css(
            "bottom",
            $(window).height() - h.navElementsOffset[l.getSize()] + "px"
          );
      }
      function t() {
          ...
          d.hasClass("first-loading") &&
            setTimeout(function () {
              y.init(),
                ...
                $("#curtain .loader-background").append(
      ...
      function o() {
        ...
        m.find("h5").text(e.loader.H5), m.find("h1").text(e.loader.H1);
      }
      function a() {
        return (
          (r = $(".container")),
        ...
        load: function () {
          return new Promise(function (e) {
            (h.completedActions = !1),
              ...
              p.css(
                "bottom",
                l.getHeight() - h.navElementsOffset[l.getSize()] + "px"
              ),
    ...
    l = (function () {
      ...
      function a() {
        ...
        return Modernizr.mediaqueries
          ? e < l.smBreakpoint ||
            (e < l.mdBreakpoint && t < l.smBreakpointHeight)
            ? n.SM
            : e < l.mdBreakpoint
            ? n.MD
            : n.LG
        ...
        $("body").on("click", "a.scroll-to", function () {
          ...
          return (
            $("html, body").animate(
              {
                scrollTop:
                  $(e).offset().top - d.headerHeight[l.getSize()] - t + n,
              },
              { duration: d.scrollTime, easing: d.scrollAnimationType }
            ),
            !1
    ...
    d = (function () {
      ...
      function i(t) {
        var n = !1;
        return (
          $("input:not(.selectric-input), textarea, select", t).each(
            function () {
              n = !e($(this), !0) || n;
            }
          ),
        ...
        $("body").off("submit", "form"),
          $("body").on("submit", "form", function () {
            ...
            return (
              ...
              n
                ? (d(e, 0), r(e, t.FORM_ERROR), !1)
                : e.hasClass("fh-no-ajax")
                ? (u(e), !0)
                : (f(e).then(
                    function (n) {
                      JSON.parse(n).error
                        ? (r(e, t.SERVER_ERROR), d(e, 0))
                        : (c(e),
                          d(e, 2),
                          e.data("submitted", !1),
      ...
      return {
        init: function () {
          v(), s.addLoadCallback(v);
        },
      };
    })(),
    u = 0,
    f = function (e, t) {
      clearTimeout(u), (u = setTimeout(e, t));
    },
    m =
      ((function () {
        var e,
      ...
      (function () {
        ...
        function t() {
          h.outerHeight(l.getHeight(!0) - parseInt(h.css("top"))),
            ...
            c.hasClass("on") &&
              (d.css(
                "bottom",
                l.getHeight() - C.navElementsOffset[l.getSize()] + "px"
              ),
              r.css(
                "bottom",
                l.getHeight() - C.navElementsOffset[l.getSize()] + "px"
        ...
        function n(e) {
          d.css("bottom", "auto"),
            ...
            c.removeClass("on"),
            e && (w.addClass("closing-nav"), w.removeClass("on loading")),
            clearTimeout(u),
            f(function () {
        ...
        function i() {
          (o = $("header#header")),
            ...
            r.on("click", function () {
              return (
                !s.getInteractionBlocked() &&
                (s.setInteractionBlocked(!0), n(!0), BNS.off(), !1)
              );
            }),
            c.on("click", function (e) {
              if ($(e.target).not("a")) {
                if (s.getInteractionBlocked()) return !1;
                s.setInteractionBlocked(!0), n(!0), BNS.off();
              }
            }),
            c.find("a").hover(
              function () {
    ...
    p = (function () {
      ...
      function i() {
        ...
        e === n.LG && (h.previousOrientation = null),
          ...
          f.outerHeight() + h.arrowSizing[e] <= t - h.wrapperOffset[e]
        ...
        $.getJSON("instagram.json", function (e) {
          if (e.error)
            ...
            for (var t = 0; t < e.posts.length; ++t) {
              var n =
                '<div class="list-item-portfolio"><a data-id="' +
                e.posts[t].id +
                '" href="' +
                e.posts[t].link +
                '" target="_blank">';
              (n +=
                '<div class="lazyload-wrapper"><img src="/instagram/' +
                e.posts[t].image +
                '" class="lazy"></div>'),
                (n += "<strong>"),
                (n += "<strong>"),
                ...
                (n +=
                  '<span class="p">' +
                  e.posts[t].text_alt.replace(/\u2060\u2800/g, "") +
                  "</span>"),
                (n += '<span class="count">'),
                (n +=
                  '<span class="icon icon-heart"><svg><use xlink:href="#icon_heart" /></svg></span><span>' +
                  e.posts[t].likes +
                  "</span>"),
                (n += "</span>"),
                (n += "</strong>"),
        ...
        if (l.getSize() === n.LG) {
          ...
          e.hover(
            ...
            function () {
              ...
              n.stop().animate({ opacity: 0 }, 250, function () {
    ...
    g =
      ((function () {
          ...
          if (e.aIn && !(n > 100)) {
            ...
            i.clearRect(0, 0, e.width, e.height),
              ...
              i.arc(
                ...
                25,
                23.5,
                1 * Math.PI + (0.5 * Math.PI * n) / 100,
                1.5 * Math.PI + (n / 100) * 2 * Math.PI
              ),
        ...
        function s() {
          $("html").hasClass("home") &&
            ((r = $("section.home-portfolio .list-item-portfolio > a.new")),
            (c = $("canvas", r)),
            o(),
            a(),
            l.removeResizeCallback(a),
      ...
      (function () {
        function e() {
          var e = new google.maps.StyledMapType([
            ...
            },
            {
              ...
              stylers: [{ visibility: "off" }, { color: "#0f141e" }],
            },
            {
            ...
            },
            {
              featureType: "poi",
              elementType: "geometry",
              stylers: [{ color: "#1b2029" }, { lightness: "0" }],
            },
            {
            ...
            },
            {
              ...
              elementType: "all",
              stylers: [{ weight: "1.00" }, { lightness: "0" }],
            },
            {
              featureType: "road.local",
              elementType: "geometry",
        ...
        function t(e) {
          (document.querySelector(".zoom-control-in").onclick = function () {
            ...
            e.controls[google.maps.ControlPosition.LEFT_TOP].push(
        ...
        function a() {
          $("html").hasClass("contact") &&
            ((r = $("section.contact-top .map")),
    ...
    v = (function () {
      ...
      function t(t) {
        if (!BNS.isOn()) {
          if (l.getSize() !== n.LG) return e(), void (m.switched = !1);
          t && (e(), (m.switched = !1));
    ...
    w = (function () {
      ...
      function i() {
        var e = -parseInt(0.3 * l.getHeight());
