!(function (e, t, n) {
    ...
    function s(e, n, i, s) {
        var o,
            ...
            h = r("div"),
            f = a();
        if (parseInt(i, 10)) for (; i--;) (u = r("div")), (u.id = s ? s[i] : p + (i + 1)), h.appendChild(u);
        return (
            (o = r("style")),
            (o.type = "text/css"),
            (o.id = "s" + p),
            ...
            (h.id = p),
            f.fake && ((f.style.background = ""), (f.style.overflow = "hidden"), (c = d.style.overflow), (d.style.overflow = "hidden"), d.appendChild(f)),
            (l = n(h, e)),
            f.fake ? (f.parentNode.removeChild(f), (d.style.overflow = c), d.offsetHeight) : h.parentNode.removeChild(h),
            !!l
        );
    }
    var o = [],
        ...
        (function () {
            ...
            for (var d in o)
                if (o.hasOwnProperty(d)) {
                    if (((e = []), (t = o[d]).name && (e.push(t.name.toLowerCase()), t.options && t.options.aliases && t.options.aliases.length))) for (n = 0; n < t.options.aliases.length; n++) e.push(t.options.aliases[n].toLowerCase());
                    for (r = i(t.fn, "function") ? t.fn() : t.fn, a = 0; a < e.length; a++)
                        (s = e[a]), 1 === (l = s.split(".")).length ? (u[l[0]] = r) : (!u[l[0]] || u[l[0]] instanceof Boolean || (u[l[0]] = new Boolean(u[l[0]])), (u[l[0]][l[1]] = r)), c.push((r ? "" : "no-") + l.join("-"));
                }
        })(),
        delete l.addTest,
    ...
    (function (e, t) {
        ...
        function o(e) {
            var t = {};
            return (
                fe.each(e.match(Le) || [], function (e, n) {
                    t[n] = !0;
                }),
                t
            );
        ...
        function g(e, t) {
            for (var n, i, r = [], a = 0, s = e.length; a < s; a++)
                (i = e[a]).style &&
                    ((n = i.style.display),
                        t ? ("none" === n && ((r[a] = ze.get(i, "display") || null), r[a] || (i.style.display = "")), "" === i.style.display && Be(i) && (r[a] = m(i))) : "none" !== n && ((r[a] = "none"), ze.set(i, "display", n)));
        ...
        function w(e, t, n, i, r) {
            ...
            for (d.textContent = "", h = 0; (a = p[h++]);)
                ...
                else if (((u = fe.contains(a.ownerDocument, a)), (s = y(d.appendChild(a), "script")), u && b(s), n)) for (c = 0; (a = s[c++]);) Xe.test(a.type || "") && n.push(a);
            return d;
        }
        function x() {
            return !0;
        ...
        function I(e, t) {
            ...
            if (1 === t.nodeType) {
                if (ze.hasData(e) && ((a = ze.access(e)), (s = ze.set(t, a)), (u = a.events))) {
                    ...
                    for (r in u) for (n = 0, i = u[r].length; n < i; n++) fe.event.add(t, r, u[r][n]);
                }
        ...
        function P(e, t, i, r) {
            ...
            if (p && ((a = w(t, e[0].ownerDocument, !1, e, r)), (s = a.firstChild), 1 === a.childNodes.length && (a = s), s || r)) {
                ...
                if (l)
                    for (c = o[o.length - 1].ownerDocument, fe.map(o, M), d = 0; d < l; d++)
                        (u = o[d]), Xe.test(u.type || "") && !ze.access(u, "globalEval") && fe.contains(c, u) && (u.src ? fe._evalUrl && fe._evalUrl(u.src) : n(u.textContent.replace(it, ""), c));
            }
            return e;
        }
        function D(e, t, n) {
        ...
        function O(e, t, n) {
            ...
            return (
                (n = n || st(e)) &&
                ("" !== (s = n.getPropertyValue(t) || n[t]) || fe.contains(e.ownerDocument, e) || (s = fe.style(e, t)),
                    !pe.pixelMarginRight() && at.test(s) && rt.test(t) && ((i = o.width), (r = o.minWidth), (a = o.maxWidth), (o.minWidth = o.maxWidth = o.width = s), (s = n.width), (o.width = i), (o.minWidth = r), (o.maxWidth = a))),
                void 0 !== s ? s + "" : s
            );
        }
        function A(e, t) {
        ...
        function H(e, t, n, i, r) {
            ...
            for (a = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0; a < 4; a += 2)
                "margin" === n && (s += fe.css(e, n + qe[a], !0, r)),
                    i
                        ? ("content" === n && (s -= fe.css(e, "padding" + qe[a], !0, r)), "margin" !== n && (s -= fe.css(e, "border" + qe[a] + "Width", !0, r)))
                        : ((s += fe.css(e, "padding" + qe[a], !0, r)), "padding" !== n && (s += fe.css(e, "border" + qe[a] + "Width", !0, r)));
            return s;
        }
        function j(e, t, n) {
            var i,
            ...
            return at.test(a)
                ? a
                : ((i = s && (pe.boxSizingReliable() || a === e.style[t])), "auto" === a && (a = e["offset" + t[0].toUpperCase() + t.slice(1)]), (a = parseFloat(a) || 0) + H(e, t, n || (s ? "border" : "content"), i, r) + "px");
        }
        ...
        function R(e, t, n) {
            for (var i, r = (W.tweeners[t] || []).concat(W.tweeners["*"]), a = 0, s = r.length; a < s; a++) if ((i = r[a].call(n, t, e))) return i;
        }
        function _(e, t) {
            var n, i, r, a, s;
            for (n in e)
        ...
        function W(e, t, n) {
            var i,
                ...
                c = u.props;
            for (_(c, u.opts.specialEasing); a < s; a++) if ((i = W.prefilters[a].call(u, e, c, u.opts))) return fe.isFunction(i.stop) && (fe._queueHooks(u.elem, u.opts.queue).stop = fe.proxy(i.stop, i)), i;
            return (
                fe.map(c, R, u),
                fe.isFunction(u.opts.start) && u.opts.start.call(e, u),
                u.progress(u.opts.progress).done(u.opts.done, u.opts.complete).fail(u.opts.fail).always(u.opts.always),
                fe.fx.timer(fe.extend(l, { elem: e, anim: u, queue: u.opts.queue })),
                u
            );
        }
        function X(e) {
        ...
        function U(e) {
            return function (t, n) {
                ...
                if (fe.isFunction(n)) for (; (i = a[r++]);) "+" === i[0] ? ((i = i.slice(1) || "*"), (e[i] = e[i] || []).unshift(n)) : (e[i] = e[i] || []).push(n);
            };
        }
        function Q(e, t, n, i) {
            function r(o) {
                    ...
                    if (null != (e = arguments[o]))
                        for (t in e)
                            (n = s[t]),
                                (i = e[t]),
                                s !== i &&
                                (u && i && (fe.isPlainObject(i) || (r = Array.isArray(i)))
                                    ? (r ? ((r = !1), (a = n && Array.isArray(n) ? n : [])) : (a = n && fe.isPlainObject(n) ? n : {}), (s[t] = fe.extend(u, a, i)))
                                    : void 0 !== i && (s[t] = i));
                return s;
            }),
            fe.extend({
                ...
                map: function (e, t, n) {
                    var r,
                        ...
                        s = 0,
                        o = [];
                    if (i(e)) for (r = e.length; s < r; s++) null != (a = t(e[s], s, n)) && o.push(a);
                ...
                proxy: function (e, t) {
                    var n, i, r;
                    if (("string" == typeof t && ((n = e[t]), (t = e), (e = n)), fe.isFunction(e)))
                        return (
        ...
        var be = (function (e) {
                ...
                return (
                    ...
                    i(function (i, s, o, l) {
                        var u,
                            ...
                            b = n ? (a || (i ? e : m || r) ? [] : s) : y;
                        if ((n && n(y, b, o, l), r)) for (u = v(b, h), r(u, [], o, l), c = u.length; c--;) (d = u[c]) && (b[h[c]] = !(y[h[c]] = d));
                        if (i) {
                            if (a || e) {
                                if (a) {
                ...
                for (
                    ...
                    if ((n = x.relative[e[o].type])) c = [p(h(c), n)];
                        ...
                        if ((n = x.filter[e[o].type].apply(null, e[o].matches))[j]) {
                            ...
                            return m(o > 1 && h(c), o > 1 && d(e.slice(0, o - 1).concat({ value: " " === e[o - 2].type ? "*" : "" })).replace(ae, "$1"), n, o < i && g(e.slice(o, i)), i < r && g((e = e.slice(i))), i < r && d(e));
                        }
                        c.push(n);
                    }
                return h(c);
                ...
                var r = n.length > 0,
                    ...
                    s = function (i, s, o, l, u) {
                        ...
                        if (((h += f), r && f !== h)) {
                            ...
                            if (i) {
                                if (h > 0) for (; f--;) m[f] || g[f] || (g[f] = G.call(l));
                                g = v(g);
                            }
            ...
            (w = t.support = {}),
                ...
                (P = t.setDocument = function (e) {
                    ...
                    return i !== D && 9 === i.nodeType && i.documentElement
                        ? ((D = i),
                            ...
                            (N = []),
                            (z = []),
                            (w.qsa = fe.test(D.querySelectorAll)) &&
                            (r(function (e) {
                            ...
                            (w.matchesSelector = fe.test(($ = O.matches || O.webkitMatchesSelector || O.mozMatchesSelector || O.oMatchesSelector || O.msMatchesSelector))) &&
                            r(function (e) {
                                ...
                                ? function (e, t) {
                                    ...
                                    return (
                                        ...
                                        (1 & (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || (!w.sortDetached && t.compareDocumentPosition(e) === n)
                                            ? e === D || (e.ownerDocument === F && H(F, e))
                                                ? -1
                                                : t === D || (t.ownerDocument === F && H(F, t))
                                                    ? 1
                                                    : I
                                                        ? J(I, e) - J(I, t)
                                                        : 0
                ...
                (t.matchesSelector = function (e, n) {
                    if (((e.ownerDocument || e) !== D && P(e), (n = n.replace(le, "='$1']")), w.matchesSelector && A && !_[n + " "] && (!N || !N.test(n)) && (!z || !z.test(n))))
                        try {
                            var i = $.call(e, n);
                                ...
                                : function (t, n, l) {
                                    ...
                                    if (m) {
                                        ...
                                        if (((f = [s ? m.firstChild : m.lastChild]), s && y)) {
                                            for (
                                                b = (h = (u = (c = (d = (p = m)[j] || (p[j] = {}))[p.uniqueID] || (d[p.uniqueID] = {}))[e] || [])[0] === q && u[1]) && u[2], p = h && m.childNodes[h];
                                            ...
                                            for (
                                                ;
                                                (p = (++h && p && p[v]) || (b = h = 0) || f.pop()) &&
                                                ((o ? p.nodeName.toLowerCase() !== g : 1 !== p.nodeType) || !++b || (y && ((d = p[j] || (p[j] = {})), (c = d[p.uniqueID] || (d[p.uniqueID] = {})), (c[e] = [q, b])), p !== t));
            ...
            return (
                ...
                (C = t.tokenize = function (e, n) {
                    ...
                    for (o = e, l = [], u = x.preFilter; o;) {
                        (i && !(r = se.exec(o))) || (r && (o = o.slice(r[0].length) || o), l.push((a = []))), (i = !1), (r = oe.exec(o)) && ((i = r.shift()), a.push({ value: i, type: r[0].replace(ae, " ") }), (o = o.slice(i.length)));
                        for (s in x.filter) !(r = de[s].exec(o)) || (u[s] && !(r = u[s](r))) || ((i = r.shift()), a.push({ value: i, type: s, matches: r }), (o = o.slice(i.length)));
                        if (!i) break;
                    }
                    ...
                    remove: function () {
                        return (
                            fe.each(arguments, function (e, t) {
                                for (var n; (n = fe.inArray(t, a, n)) > -1;) a.splice(n, 1), n <= l && l--;
                            }),
                            this
                        );
                    },
                                            ...
                                            d = function () {
                                                ...
                                                if (!(t < s)) {
                                                    ...
                                                    (d = e && ("object" == typeof e || "function" == typeof e) && e.then),
                                                        fe.isFunction(d)
                                                            ? r
                                                                ? d.call(e, a(s, n, l, r), a(s, n, u, r))
                                                                : (s++, d.call(e, a(s, n, l, r), a(s, n, u, r), a(s, n, l, n.notifyWith)))
                                                            : (i !== l && ((o = void 0), (c = [e])), (r || n.resolveWith)(o, c));
                                                }
                                            },
                                            p = r
                                                ? d
        ...
        (fe.fn.ready = function (e) {
            ...
            "complete" === te.readyState || ("loading" !== te.readyState && !te.documentElement.doScroll) ? e.setTimeout(fe.ready) : (te.addEventListener("DOMContentLoaded", d), e.addEventListener("load", d));
        ...
        (p.uid = 1),
            (p.prototype = {
                ...
                set: function (e, t, n) {
                    ...
                    else for (i in t) r[fe.camelCase(i)] = t[i];
                    return r;
                },
                get: function (e, t) {
        ...
        (fe.event = {
                    ...
                    for (
                        ...
                        (o = Je.exec(t[u]) || []),
                            ...
                            ((d = fe.event.special[h] || {}),
                                ...
                                (d = fe.event.special[h] || {}),
                                (c = fe.extend({ type: h, origType: v, data: i, handler: n, guid: n.guid, selector: r, needsContext: r && fe.expr.match.needsContext.test(r), namespace: f.join(".") }, a)),
                                (p = l[h]) || ((p = l[h] = []), (p.delegateCount = 0), (d.setup && !1 !== d.setup.call(e, i, f, s)) || (e.addEventListener && e.addEventListener(h, s))),
                ...
                if (m && (l = m.events)) {
                    for (u = (t = (t || "").match(Le) || [""]).length; u--;)
                        if (((o = Je.exec(t[u]) || []), (h = v = o[1]), (f = (o[2] || "").split(".").sort()), h)) {
                            for (d = fe.event.special[h] || {}, p = l[(h = (i ? d.delegateType : d.bindType) || h)] || [], o = o[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), s = a = p.length; a--;)
                                (c = p[a]),
                                    (!r && v !== c.origType) ||
                                    (n && n.guid !== c.guid) ||
            ...
            dispatch: function (e) {
                ...
                if (((o.delegateTarget = this), !c.preDispatch || !1 !== c.preDispatch.call(this, o))) {
                    for (s = fe.event.handlers.call(this, o, u), t = 0; (r = s[t++]) && !o.isPropagationStopped();)
                        for (o.currentTarget = r.elem, n = 0; (a = r.handlers[n++]) && !o.isImmediatePropagationStopped();)
                            (o.rnamespace && !o.rnamespace.test(a.namespace)) ||
                                ((o.handleObj = a), (o.data = a.data), void 0 !== (i = ((fe.event.special[a.origType] || {}).handle || a.handler).apply(r.elem, l)) && !1 === (o.result = i) && (o.preventDefault(), o.stopPropagation()));
        ...
        fe.extend({
            ...
            clone: function (e, t, n) {
                ...
                if (!(pe.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || fe.isXMLDoc(e))) for (s = y(o), a = y(e), i = 0, r = a.length; i < r; i++) L(a[i], s[i]);
                if (t)
                    if (n) for (a = a || y(e), s = s || y(o), i = 0, r = a.length; i < r; i++) I(a[i], s[i]);
                    else I(e, o);
        ...
        fe.extend({
                    ...
                    return (
                        ...
                        void 0 === n
                            ? s && "get" in s && void 0 !== (r = s.get(e, !1, i))
                                ? r
                                : u[t]
                            : ("string" === (a = typeof n) && (r = Fe.exec(n)) && r[1] && ((n = v(e, t, r)), (a = "number")),
                                void (
                                    null != n &&
                                    n === n &&
                                    ("number" === a && (n += (r && r[3]) || (fe.cssNumber[o] ? "" : "px")),
            ...
            fe.each(["height", "width"], function (e, t) {
                fe.cssHooks[t] = {
                    get: function (e, n, i) {
                        if (n)
                            return !ot.test(fe.css(e, "display")) || (e.getClientRects().length && e.getBoundingClientRect().width)
                                ? j(e, t, i)
                                : Ve(e, ut, function () {
                                    return j(e, t, i);
                                });
        ...
        (fe.Animation = fe.extend(W, {
            ...
            prefilters: [
                function (e, t, n) {
                    var i,
                        ...
                        m = ze.get(e, "fxshow");
                    n.queue ||
                        (null == (s = fe._queueHooks(e, "fx")).unqueued &&
                            ((s.unqueued = 0),
                                (o = s.empty.fire),
                    ...
                    if ((l = !fe.isEmptyObject(t)) || !fe.isEmptyObject(h)) {
                        d &&
                            ...
                            ((n.overflow = [f.overflow, f.overflowX, f.overflowY]),
                                ...
                                "none" === (c = fe.css(e, "display")) && (u ? (c = u) : (g([e], !0), (u = e.style.display || u), (c = fe.css(e, "display")), g([e]))),
                        ...
                        for (i in h)
                            l ||
                                (m ? "hidden" in m && (v = m.hidden) : (m = ze.access(e, "fxshow", { display: u })),
                                    a && (m.hidden = !v),
                                    v && g([e], !0),
                                    p.done(function () {
            ...
            (fe.speed = function (e, t, n) {
                var i = e && "object" == typeof e ? fe.extend({}, e) : { complete: n || (!n && t) || (fe.isFunction(e) && e), duration: e, easing: (n && t) || (t && !fe.isFunction(t) && t) };
                return (
                    fe.fx.off ? (i.duration = 0) : "number" != typeof i.duration && (i.duration in fe.fx.speeds ? (i.duration = fe.fx.speeds[i.duration]) : (i.duration = fe.fx.speeds._default)),
            ...
            fe.each({ slideDown: V("show"), slideUp: V("hide"), slideToggle: V("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (e, t) {
                ...
                attr: function (e, t, n) {
                    ...
                    if (3 !== a && 8 !== a && 2 !== a)
                        return void 0 === e.getAttribute
                            ? fe.prop(e, t, n)
                            : ((1 === a && fe.isXMLDoc(e)) || (r = fe.attrHooks[t.toLowerCase()] || (fe.expr.match.bool.test(t) ? gt : void 0)),
                                void 0 !== n
                                    ? null === n
        ...
        fe.fn.extend({
            ...
            fe.extend({
                prop: function (e, t, n) {
                    ...
                    if (3 !== a && 8 !== a && 2 !== a)
                        return (
                            (1 === a && fe.isXMLDoc(e)) || ((t = fe.propFix[t] || t), (r = fe.propHooks[t])),
                ...
                toggleClass: function (e, t) {
                    ...
                    return "boolean" == typeof t && "string" === n
                        ...
                        : fe.isFunction(e)
                            ...
                            : this.each(function () {
                                var t, i, r, a;
                                if ("string" === n) for (i = 0, r = fe(this), a = e.match(Le) || []; (t = a[i++]);) r.hasClass(t) ? r.removeClass(t) : r.addClass(t);
                ...
                return arguments.length
                    ? ((i = fe.isFunction(e)),
                        this.each(function (n) {
                            var r;
                            1 === this.nodeType &&
                                (null == (r = i ? e.call(this, n, fe(this).val()) : e)
                                    ? (r = "")
                                    : "number" == typeof r
                                        ? (r += "")
                                        : Array.isArray(r) &&
                    ...
                    : r
                        ? (t = fe.valHooks[r.type] || fe.valHooks[r.nodeName.toLowerCase()]) && "get" in t && void 0 !== (n = t.get(r, "value"))
                            ? n
                ...
                if (
                    ...
                    for (a = 0; (s = p[a++]) && !t.isPropagationStopped();)
                        (t.type = a > 1 ? l : d.bindType || h),
                            ...
                            (c = u && s[u]) && c.apply && Ae(s) && ((t.result = c.apply(s, n)), !1 === t.result && t.preventDefault());
                    return (
                        (t.type = h),
                        r ||
                        ...
                        !Ae(i) ||
                        (u && fe.isFunction(i[h]) && !fe.isWindow(i) && ((o = i[u]) && (i[u] = null), (fe.event.triggered = h), i[h](), (fe.event.triggered = void 0), o && (i[u] = o))),
                        t.result
                    );
                }
            },
            ...
            fe.extend({
                ...
                ajax: function (t, n) {
                    function i(t, n, i, o) {
                        ...
                        c ||
                            ((c = !0),
                                ...
                                (w = Z(f, w, E, u)),
                                u
                                    ? (f.ifModified && ((x = E.getResponseHeader("Last-Modified")) && (fe.lastModified[a] = x), (x = E.getResponseHeader("etag")) && (fe.etag[a] = x)),
                                        204 === t || "HEAD" === f.type ? (T = "nocontent") : 304 === t ? (T = "notmodified") : ((T = w.state), (p = w.data), (h = w.error), (u = !h)))
                                ...
                                y.fireWith(v, [E, T]),
                                d && (m.trigger("ajaxComplete", [E, f]), --fe.active || fe.event.trigger("ajaxStop")));
                    }
                    ...
                    (d = fe.event && f.global) && 0 == fe.active++ && fe.event.trigger("ajaxStart"),
                        ...
                        (a = f.url.replace(Dt, "")),
                        f.hasContent
                            ? f.data && f.processData && 0 === (f.contentType || "").indexOf("application/x-www-form-urlencoded") && (f.data = f.data.replace(Pt, "+"))
                            : ((h = f.url.slice(a.length)),
                                f.data && ((a += (St.test(a) ? "&" : "?") + f.data), delete f.data),
                                !1 === f.cache && ((a = a.replace(Ot, "$1")), (h = (St.test(a) ? "&" : "?") + "_=" + Ct++ + h)),
                                (f.url = a + h)),
                        f.ifModified && (fe.lastModified[a] && E.setRequestHeader("If-Modified-Since", fe.lastModified[a]), fe.etag[a] && E.setRequestHeader("If-None-Match", fe.etag[a])),
                    ...
                    return {
                        send: function (r, a) {
                            ...
                            (n = function (e) {
                                return function () {
                                    n &&
                                        ((n = i = o.onload = o.onerror = o.onabort = o.onreadystatechange = null),
                                            "abort" === e
                                                ? o.abort()
                                                : "error" === e
        ...
        fe.ajaxSetup({
            ...
            fe.ajaxPrefilter("json jsonp", function (t, n, i) {
                var r,
                    a,
                    s,
                    o = !1 !== t.jsonp && (_t.test(t.url) ? "url" : "string" == typeof t.data && 0 === (t.contentType || "").indexOf("application/x-www-form-urlencoded") && _t.test(t.data) && "data");
                if (o || "jsonp" === t.dataTypes[0])
                    return (
                        (r = t.jsonpCallback = fe.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback),
            ...
            (fe.parseHTML = function (e, t, n) {
                ...
                var i, r, a;
                return (
                    t || (pe.createHTMLDocument ? ((t = te.implementation.createHTMLDocument("")), (i = t.createElement("base")), (i.href = te.location.href), t.head.appendChild(i)) : (t = te)),
                    (r = Ee.exec(e)),
                    (a = !n && []),
                    r ? [t.createElement(r[1])] : ((r = w([e], t, a)), a && a.length && fe(a).remove(), fe.merge([], r.childNodes))
                );
            }),
            (fe.fn.load = function (e, t, n) {
                var i,
                    ...
                    o = e.indexOf(" ");
                return (
                    o > -1 && ((i = X(e.slice(o))), (e = e.slice(0, o))),
                    fe.isFunction(t) ? ((n = t), (t = void 0)) : t && "object" == typeof t && (r = "POST"),
                    s.length > 0 &&
                    fe
            ...
            (fe.offset = {
                setOffset: function (e, t, n) {
                    ...
                    "static" === u && (e.style.position = "relative"),
                        ...
                        (a = fe.css(e, "top")),
                        (l = fe.css(e, "left")),
                        ("absolute" === u || "fixed" === u) && (a + l).indexOf("auto") > -1 ? ((i = c.position()), (s = i.top), (r = i.left)) : ((s = parseFloat(a) || 0), (r = parseFloat(l) || 0)),
                ...
                offset: function (e) {
                    ...
                    return a
                        ? a.getClientRects().length
                            ? ((i = a.getBoundingClientRect()), (t = a.ownerDocument), (n = t.documentElement), (r = t.defaultView), { top: i.top + r.pageYOffset - n.clientTop, left: i.left + r.pageXOffset - n.clientLeft })
                            : { top: 0, left: 0 }
                        : void 0;
                },
                position: function () {
                    if (this[0]) {
                        ...
                        return (
                            "fixed" === fe.css(n, "position")
                                ...
                                : ((e = this.offsetParent()), (t = this.offset()), r(e[0], "html") || (i = e.offset()), (i = { top: i.top + fe.css(e[0], "borderTopWidth", !0), left: i.left + fe.css(e[0], "borderLeftWidth", !0) })),
                            { top: t.top - i.top - fe.css(n, "marginTop", !0), left: t.left - i.left - fe.css(n, "marginLeft", !0) }
                        );
                    }
                },
            ...
            e.extend(e.easing, {
                ...
                easeInElastic: function (e, t, n, i, r) {
                    ...
                    return 0 == t
                        ...
                        : 1 == (t /= r)
                            ? n + i
                            : (a || (a = 0.3 * r), s < Math.abs(i) ? ((s = i), (e = a / 4)) : (e = (a / (2 * Math.PI)) * Math.asin(i / s)), -s * Math.pow(2, 10 * --t) * Math.sin((2 * (t * r - e) * Math.PI) / a) + n);
                },
                easeOutElastic: function (e, t, n, i, r) {
                    ...
                    return 0 == t
                        ...
                        : 1 == (t /= r)
                            ? n + i
                            : (a || (a = 0.3 * r), s < Math.abs(i) ? ((s = i), (e = a / 4)) : (e = (a / (2 * Math.PI)) * Math.asin(i / s)), s * Math.pow(2, -10 * t) * Math.sin((2 * (t * r - e) * Math.PI) / a) + i + n);
                },
                easeInOutElastic: function (e, t, n, i, r) {
                    ...
                    return 0 == t
                        ...
                        : 2 == (t /= r / 2)
                            ? n + i
                            : (a || (a = 0.3 * r * 1.5),
                                s < Math.abs(i) ? ((s = i), (e = a / 4)) : (e = (a / (2 * Math.PI)) * Math.asin(i / s)),
                                1 > t ? -0.5 * s * Math.pow(2, 10 * --t) * Math.sin((2 * (t * r - e) * Math.PI) / a) + n : s * Math.pow(2, -10 * --t) * Math.sin((2 * (t * r - e) * Math.PI) / a) * 0.5 + i + n);
                },
                ...
                easeInOutBounce: function (t, n, i, r, a) {
                    return n < a / 2 ? 0.5 * e.easing.easeInBounce(t, 2 * n, 0, r, a) + i : 0.5 * e.easing.easeOutBounce(t, 2 * n - a, 0, r, a) + 0.5 * r + i;
                },
            });
    })(jQuery),
    (function (e) {
        ...
        e.html5Loader = function (t) {
            var n = {
                ...
                w = (function (e) {
                    return !(
                        !/android.+mobile|avantgo|bada\/|blackberry|blazer|compal|elaine|fennec|hiptop|iemobile|ip(hone|od)|iris|kindle|lge |maemo|meego.+mobile|midp|mmp|netfront|opera m(ob|in)i|palm( os)?|phone|p(ixi|re)\/|plucker|pocket|psp|series(4|6)0|symbian|treo|up\.(browser|link)|vodafone|wap|windows (ce|phone)|xda|xiino/i.test(
                            e
                        ) &&
            ...
            var E = function (t) {
                ...
                M = function (t) {
                    if (!i.cancelLoading) {
                        var n,
                            ...
                            s = e("<img>");
                        return (
                            "[object Object]" === t.source.toString() ? (t.source.svg && x.svg ? (n = t.source.svg) : t.source.fallback && (n = t.source.fallback)) : (n = t.source),
                            s.on("load", function () {
                        ...
                        return (
                            w || b
                                ...
                                : (a.on("loadstart", function () {
                                    ...
                                    a.attr({ preload: "auto", src: t.source, controls: "controls" }),
                ...
                L = function (t) {
                    if (!i.cancelLoading) {
                        var n = new e.Deferred(),
                            r = t.size,
                            a = { url: t.source, dataType: "script" };
                        return (
                            ((void 0 === t.stopExecution && l) || !0 === t.stopExecution) &&
                            (a.converters = {
                                "text script": function (e) {
                                    return e;
                                },
        ...
        (o.prototype = {
            ...
            init: function (t) {
                ...
                if (((n.options = e.extend(!0, {}, e.fn[i].defaults, n.options, t)), n.utils.triggerCallback("BeforeInit", n), n.destroy(!0), n.options.disableOnMobile && n.utils.isMobile())) n.disableOnMobile = !0;
                    ...
                    var r = e("<input/>", { class: n.classes.input, readonly: n.utils.isMobile() }),
                        a = e("<div/>", { class: n.classes.items, tabindex: -1 }),
                        s = e("<div/>", { class: n.classes.scroll }),
                        o = e("<div/>", { class: n.classes.prefix, html: n.options.arrowButtonMarkup }),
                        l = e("<span/>", { class: "label" }),
                        u = n.$element.wrap("<div/>").parent().append(o.prepend(l), a, r),
                        c = e("<div/>", { class: n.classes.hideselect });
                    (n.elements = { input: r, items: a, itemsScroll: s, wrapper: o, label: l, outerWrapper: u }),
            ...
            getClassNames: function () {
                var t = this,
                    ...
                    i = {};
                return (
                    e.each("Input Items Open Disabled TempShow HideSelect Wrapper Focus Hover Responsive Above Scroll Group GroupLabel".split(" "), function (e, r) {
                        var a = n.prefix + r;
            ...
            setLabel: function () {
                ...
                if (t.state.multiple) {
                    ...
                    (r = e.grep(r, function (t) {
                        ...
                        (r.length >= t.options.multiple.maxLabelEntries + 1 ? (r = r.slice(0, t.options.multiple.maxLabelEntries)).push(e.isFunction(n) ? n({ text: "..." }) : t.utils.format(n, { text: "..." })) : r.slice(r.length - 1)),
            ...
            populate: function () {
                ...
                r.length > 1 &&
                    ...
                    (n.each(function (n) {
                        var i = e(this);
                        if (i.is("optgroup")) {
                            var r = { element: i, label: i.prop("label"), groupDisabled: i.prop("disabled"), items: [] };
            ...
            getItemData: function (t, n, i) {
                var r = this;
                return { index: t, element: n, value: n.val(), className: n.prop("class"), text: n.html(), slug: e.trim(r.utils.replaceDiacritics(n.html())), selected: n.prop("selected"), disabled: i };
            },
                    ...
                    e.each(t, function (t, r) {
                        void 0 !== r.label
                            ? ((i += n.utils.format(
                                ...
                                n.utils.arrayToClassname([n.classes.group, r.groupDisabled ? "disabled" : "", r.element.prop("class")]),
                                n.classes.grouplabel,
                                r.element.prop("label")
                            )),
                                e.each(r.items, function (e, t) {
                                    i += n.getItemMarkup(t.index, t);
                                }),
                                (i += "</ul>"))
                            : (i += n.getItemMarkup(r.index, r));
                    }),
                    i + "</ul>"
                );
            },
            getItemMarkup: function (t, n) {
                var i = this,
                    ...
                    a = { value: n.value, text: n.text, slug: n.slug, index: n.index };
                return i.utils.format(
                    ...
                    e.isFunction(r) ? i.utils.format(r(n), n) : i.utils.format(r, a)
                );
            },
            ...
            bindEvents: function () {
                ...
                t.elements.outerWrapper.on("mouseenter.sl mouseleave" + r, function (n) {
                    e(this).toggleClass(t.classes.hover, "mouseenter" === n.type),
                        t.options.openOnHover && (clearTimeout(t.closeTimer), "mouseleave" === n.type ? (t.closeTimer = setTimeout(e.proxy(t.close, t), t.options.hoverIntentTimeout)) : t.open());
                }),
                    t.elements.wrapper.on("click" + r, function (e) {
                        t.state.opened ? t.close() : t.open(e);
                    }),
                    (t.options.nativeOnMobile && t.utils.isMobile()) ||
                    (t.$element.on("focus" + r, function () {
                        t.elements.input.focus();
                    }),
                        t.elements.input
                            .prop({ tabindex: t.originalTabindex, disabled: !1 })
                            .on("keydown" + r, e.proxy(t.handleKeys, t))
            ...
            setOptionsDimensions: function () {
                ...
                !e.options.expandToItemText || r > i
                    ? (e.finalWidth = r)
            ...
            open: function (n) {
                ...
                return (
                    ...
                    (a.utils.triggerCallback("BeforeOpen", a),
                        n && (n.preventDefault(), n.stopPropagation()),
                        void (
                            a.state.enabled &&
                            (a.setOptionsDimensions(),
                                e("." + a.classes.hideselect, "." + a.classes.open)
                                    .children()
                                [i]("close"),
                                (a.state.opened = !0),
                                ...
                                a.isInViewport(),
                                a.options.preventWindowScroll &&
                                t.on("mousewheel.sl DOMMouseScroll" + r, "." + a.classes.scroll, function (t) {
            ...
            highlight: function (e) {
                ...
                t.utils.triggerCallback("BeforeHighlight", t),
                    void 0 === e || -1 === e || t.lookupItems[e].disabled || (n.eq((t.state.highlightedIdx = e)).addClass("highlighted"), t.detectItemVisibility(e), t.utils.triggerCallback("Highlight", t));
            },
            select: function (t) {
                var n = this,
    ...
    (function (e, t, n, i) {
        ...
        function s(e, t, n) {
            ...
            if (e)
                ...
                else if (e.length !== i) for (r = 0; r < e.length;) t.call(n, e[r], r, e), r++;
        ...
        function I(e, t) {
            var n = t.center,
                ...
                r = e.prevDelta || {},
                a = e.prevInput || {};
            (t.eventType === Te || a.eventType === Ce) && ((r = e.prevDelta = { x: a.deltaX || 0, y: a.deltaY || 0 }), (i = e.offsetDelta = { x: n.x, y: n.y })), (t.deltaX = r.x + (n.x - i.x)), (t.deltaY = r.y + (n.y - i.y));
        }
        function L(e, t) {
            var n,
                r,
        ...
        function P(e) {
            ...
            return { timeStamp: he(), pointers: t, center: D(t), deltaX: e.deltaX, deltaY: e.deltaY };
        }
        function D(e) {
            var t = e.length;
        ...
        var $e = { mousedown: Te, mousemove: Ee, mouseup: Ce },
            He = "mousedown",
        ...
        u(j, C, {
            handler: function (e) {
                ...
                t & Te && 0 === e.button && (this.pressed = !0),
                    t & Ee && 1 !== e.which && (t = Ce),
                    this.pressed && this.allow && (t & Ce && (this.pressed = !1), this.callback(this.manager, t, { pointers: [e], changedPointers: [e], pointerType: we, srcEvent: e }));
            },
        });
        var Fe = { pointerdown: Te, pointermove: Ee, pointerup: Ce, pointercancel: Se, pointerout: Se },
            qe = { 2: be, 3: "pen", 4: we, 5: "kinect" },
            Be = "pointerdown",
            Ve = "pointermove pointerup pointercancel";
        e.MSPointerEvent && ((Be = "MSPointerDown"), (Ve = "MSPointerMove MSPointerUp MSPointerCancel")),
            u(F, C, {
                handler: function (e) {
                    var t = this.store,
                        n = !1,
                    ...
                    r & Te && (0 === e.button || s) ? 0 > o && (t.push(e), (o = t.length - 1)) : r & (Ce | Se) && (n = !0),
                        0 > o || ((t[o] = e), this.callback(this.manager, r, { pointers: t, changedPointers: [e], pointerType: a, srcEvent: e }), n && t.splice(o, 1));
                },
            });
        var Re = { touchstart: Te, touchmove: Ee, touchend: Ce, touchcancel: Se },
            _e = "touchstart",
        ...
        u(q, C, {
            handler: function (e) {
                ...
                if ((t === Te && (this.started = !0), this.started)) {
                    ...
                    t & (Ce | Se) && n[0].length - n[1].length == 0 && (this.started = !1), this.callback(this.manager, t, { pointers: n[0], changedPointers: n[1], pointerType: be, srcEvent: e });
                }
            },
        });
        var Xe = { touchstart: Te, touchmove: Ee, touchend: Ce, touchcancel: Se },
        ...
        (Y.prototype = {
            ...
            recognize: function (e) {
                ...
                return d(this.options.enable, [this, t])
                    ? (this.state & (st | ot | 32) && (this.state = nt), (this.state = this.process(t)), void (this.state & (it | rt | at | ot) && this.tryEmit(t)))
            ...
            u(J, K, {
                ...
                directionTest: function (e) {
                    var t = this.options,
                        ...
                        s = e.deltaY;
                    return (
                        r & t.direction || (t.direction & De ? ((r = 0 === a ? ke : 0 > a ? Me : Ie), (n = a != this.pX), (i = Math.abs(e.deltaX))) : ((r = 0 === s ? ke : 0 > s ? Le : Pe), (n = s != this.pY), (i = Math.abs(e.deltaY)))),
                        (e.direction = r),
            ...
            u(ne, K, {
                defaults: { event: "swipe", threshold: 10, velocity: 0.65, direction: De | Oe, pointers: 1 },
                getTouchAction: function () {
                ...
                attrTest: function (e) {
                    ...
                    return (
                        n & (De | Oe) ? (t = e.velocity) : n & De ? (t = e.velocityX) : n & Oe && (t = e.velocityY),
            ...
            u(ie, Y, {
                ...
                process: function (e) {
                    ...
                    if (i && a && n) {
                        ...
                        if (((this.pTime = e.timeStamp), (this.pCenter = e.center), o && s ? (this.count += 1) : (this.count = 1), (this._input = e), 0 === this.count % t.taps))
            ...
            (re.defaults = {
                ...
                inputTarget: null,
                inputClass: null,
                preset: [[te, { enable: !1 }], [Z, { enable: !1 }, ["rotate"]], [ne, { direction: De }], [J, { direction: De }, ["swipe"]], [ie], [ie, { event: "doubletap", taps: 2 }, ["tap"]], [ee]],
...
var mediaQueriesHelper = (function () {
    function e(e, t) {
        var n,
            i = e.cssRules ? e.cssRules : e.media,
            r = [],
            a = 0,
            s = i.length;
        ...
        var n,
            ...
            o = {
                ...
                adjustMediaQuery: function (e) {
                    return mqGenie.adjusted
                        ? e.replace(/\d+px/gi, function (e) {
...
(window.$clamp = function (e, t) {
    ...
    function a(t) {
        return t.lastChild.children && 0 < t.lastChild.children.length
            ? a(Array.prototype.slice.call(t.children).pop())
            : t.lastChild && t.lastChild.nodeValue && "" != t.lastChild.nodeValue && t.lastChild.nodeValue != c.truncationChar
                ? t.lastChild
                : (t.lastChild.parentNode.removeChild(t.lastChild), a(e));
    }
    function s(t, n) {
        if (n) {
            var i = t.nodeValue.replace(c.truncationChar, "");
            if (
                (m || ((b = 0 < y.length ? y.shift() : ""), (m = i.split(b))),
                    1 < m.length ? ((g = m.pop()), o(t, m.join(b))) : (m = null),
                    l && ((t.nodeValue = t.nodeValue.replace(c.truncationChar, "")), (e.innerHTML = t.nodeValue + " " + l.innerHTML + c.truncationChar)),
                    m)
            ) {
                if (e.clientHeight <= n) {
    ...
    return (
        h && c.useNativeClamp
            ? ((d.overflow = "hidden"), (d.textOverflow = "ellipsis"), (d.webkitBoxOrient = "vertical"), (d.display = "-webkit-box"), (d.webkitLineClamp = f), v && (d.height = c.clamp + "px"))
            : (d = (function (t) {
                return r(e) * t;
    ...
    (function (e) {
        window.BNS = new (function () {
            var e = { prevScroll: 0, prevPosition: "", prevOverflow: "", prevClasses: "", on: !1, classes: "start-overlay-transition" },
            ...
            return {
                ...
                on: function (i) {
                    ...
                    (document.body.className = document.body.className + " " + e.classes + " " + i),
                        t && ((document.body.style.top = -e.prevScroll + "px"), (document.body.style.position = "fixed"), (document.body.style.overflow = "hidden")),
                        bodyScrollLock.disableBodyScroll(document.querySelector("#nav"), { reserveScrollBarGap: !0 });
                },
                off: function () {
                    if (t) {
                        if (!e.on) return;
                    ...
                    (document.body.className = e.prevClasses), bodyScrollLock.enableBodyScroll(document.querySelector("#nav"), { reserveScrollBarGap: !0 });
                },
            };
        })();
    })();
...
!(function (e, t) {
    ...
    return (
        ...
        (function (e, t) {
            if (t)
                if (t.length) for (var n, i = 0; (n = t[i]); i += 1) u(e, n);
                else u(e, t);
        ...
        function e(e, t) {
            ...
            if (e)
                if ("string" == typeof e) {
                    ...
                    } else for (r = t || "#" !== e[0] || e.match(/[ .<>:~]/) ? (t || l).querySelectorAll(e.trim()) : [l.getElementById(e.trim().split("#")[1])], i = 0; i < r.length; i += 1) r[i] && n.push(r[i]);
                ...
                if (
                    ...
                    if (r.noSwiping && e(s.target).closest(r.noSwipingSelector ? r.noSwipingSelector : "." + r.noSwipingClass)[0]) n.allowClick = !0;
                        ...
                        if (!d || !(o <= h || o >= u.screen.width - h)) {
                            if (
                                (p.extend(i, { isTouched: !0, isMoved: !1, allowTouchCallbacks: !0, isScrolling: void 0, startMoving: void 0 }),
                                    (a.startX = o),
                                    (a.startY = c),
        ...
        function i(t) {
            ...
            if ((o.originalEvent && (o = o.originalEvent), i.isTouched)) {
                if (!i.isTouchEvent || "mousemove" !== o.type) {
                    ...
                    if (!n.allowTouchMove) return (n.allowClick = !1), void (i.isTouched && (p.extend(a, { startX: u, startY: c, currentX: u, currentY: c }), (i.touchStartTime = p.now())));
                        ...
                        if (!(n.params.threshold && Math.sqrt(Math.pow(d, 2) + Math.pow(h, 2)) < n.params.threshold)) {
                            if (void 0 === i.isScrolling) {
                                ...
                                (n.isHorizontal() && a.currentY === a.startY) || (n.isVertical() && a.currentX === a.startX)
                                    ? (i.isScrolling = !1)
                                    : d * d + h * h >= 25 && ((f = (180 * Math.atan2(Math.abs(h), Math.abs(d))) / Math.PI), (i.isScrolling = n.isHorizontal() ? f > r.touchAngle : 90 - f > r.touchAngle));
                            }
                                ...
                                if (
                                    (r.touchReleaseOnEdges && (g = 0),
                                        v > 0 && i.currentTranslate > n.minTranslate()
                                            ? ((m = !1), r.resistance && (i.currentTranslate = n.minTranslate() - 1 + Math.pow(-n.minTranslate() + i.startTranslate + v, g)))
                                            : v < 0 && i.currentTranslate < n.maxTranslate() && ((m = !1), r.resistance && (i.currentTranslate = n.maxTranslate() + 1 - Math.pow(n.maxTranslate() - i.startTranslate - v, g))),
                                ...
                                r.followFinger &&
                                    ((r.freeMode || r.watchSlidesProgress || r.watchSlidesVisibility) && (n.updateActiveIndex(), n.updateSlidesClasses()),
                                        ...
                                        (0 === i.velocities.length && i.velocities.push({ position: a[n.isHorizontal() ? "startX" : "startY"], time: i.touchStartTime }),
                                            i.velocities.push({ position: a[n.isHorizontal() ? "currentX" : "currentY"], time: p.now() })),
        ...
        function r(e) {
            ...
            if (((h = i.followFinger ? (a ? t.translate : -t.translate) : -n.currentTranslate), i.freeMode)) {
                ...
                if (i.freeModeMomentum) {
                    ...
                    if (w < t.maxTranslate())
                        i.freeModeMomentumBounce ? (w + t.maxTranslate() < -C && (w = t.maxTranslate() - C), (x = t.maxTranslate()), (E = !0), (n.allowMomentumBounce = !0)) : (w = t.maxTranslate()), i.loop && i.centeredSlides && (T = !0);
                    else if (w > t.minTranslate())
                        i.freeModeMomentumBounce ? (w - t.minTranslate() > C && (w = t.minTranslate() + C), (x = t.minTranslate()), (E = !0), (n.allowMomentumBounce = !0)) : (w = t.minTranslate()), i.loop && i.centeredSlides && (T = !0);
                ...
                for (var M = 0, I = t.slidesSizesGrid[0], L = 0; L < o.length; L += i.slidesPerGroup)
                    void 0 !== o[L + i.slidesPerGroup] ? h >= o[L] && h < o[L + i.slidesPerGroup] && ((M = L), (I = o[L + i.slidesPerGroup] - o[L])) : h >= o[L] && ((M = L), (I = o[o.length - 1] - o[o.length - 2]));
                var P = (h - o[M]) / I;
                if (d > i.longSwipesMs) {
        ...
        var d = {
                ...
                for (var c, d = s.split(" "), p = 0; p < this.length; p += 1) {
                    ...
                    if (o)
                        for (c = 0; c < d.length; c += 1) {
                            var f = d[c];
                            h.dom7LiveListeners || (h.dom7LiveListeners = {}), h.dom7LiveListeners[f] || (h.dom7LiveListeners[f] = []), h.dom7LiveListeners[f].push({ listener: l, proxyListener: t }), h.addEventListener(f, t, u);
                        }
                    else
                        for (c = 0; c < d.length; c += 1) {
                            var v = d[c];
                            h.dom7Listeners || (h.dom7Listeners = {}), h.dom7Listeners[v] || (h.dom7Listeners[v] = []), h.dom7Listeners[v].push({ listener: l, proxyListener: n }), h.addEventListener(v, n, u);
                        }
                }
                return this;
            },
                    ...
                    for (var u = o[l], c = 0; c < this.length; c += 1) {
                        ...
                        if ((!r && d.dom7Listeners ? (p = d.dom7Listeners[u]) : r && d.dom7LiveListeners && (p = d.dom7LiveListeners[u]), p && p.length))
                            for (var h = p.length - 1; h >= 0; h -= 1) {
                                var f = p[h];
                                a && f.listener === a
                                    ? (d.removeEventListener(u, f.proxyListener, s), p.splice(h, 1))
                                    : a && f.listener && f.listener.dom7proxy && f.listener.dom7proxy === a
                                        ? (d.removeEventListener(u, f.proxyListener, s), p.splice(h, 1))
                                        : a || (d.removeEventListener(u, f.proxyListener, s), p.splice(h, 1));
                            }
                    }
                return this;
            },
                ...
                for (var n = e[0].split(" "), i = e[1], r = 0; r < n.length; r += 1)
                    for (var a = n[r], s = 0; s < this.length; s += 1) {
                        var o = this[s],
                            c = void 0;
                        try {
                            c = new u.CustomEvent(a, { detail: i, bubbles: !0, cancelable: !0 });
                        } catch (e) {
            ...
            append: function () {
                ...
                for (var n, i = 0; i < e.length; i += 1) {
                    ...
                    for (var r = 0; r < this.length; r += 1)
                        ...
                        } else if (n instanceof c) for (var s = 0; s < n.length; s += 1) this[r].appendChild(n[s]);
            ...
            prepend: function (e) {
                ...
                for (t = 0; t < this.length; t += 1)
                    ...
                    } else if (e instanceof c) for (n = 0; n < e.length; n += 1) this[t].insertBefore(e[n], this[t].childNodes[0]);
        ...
        var p = {
                    ...
                    u.WebKitCSSMatrix
                        ? ((i = a.transform || a.webkitTransform).split(",").length > 6 &&
                            (i = i
                                ...
                                .join(", ")),
                            (r = new u.WebKitCSSMatrix("none" === i ? "" : i)))
            ...
            parseUrlQuery: function (e) {
                ...
                if ("string" == typeof s && s.length)
                    for (
                        r = (n = (s = s.indexOf("?") > -1 ? s.replace(/\S*\?/, "") : "").split("&").filter(function (e) {
                            return "" !== e;
                        })).length,
                        t = 0;
                        t < r;
            ...
            h = (function () {
                ...
                return {
                    ...
                    transforms3d:
                        (u.Modernizr && !0 === u.Modernizr.csstransforms3d) ||
                        (function () {
                            var t = e.style;
        ...
        var g = {
            updateSize: function () {
                ...
                (e = void 0 !== n.params.width ? n.params.width : i[0].clientWidth),
                    ...
                    ((e = e - parseInt(i.css("padding-left"), 10) - parseInt(i.css("padding-right"), 10)),
                        ...
                        p.extend(n, { width: e, height: t, size: n.isHorizontal() ? e : t }));
            },
            updateSlides: function () {
                ...
                var y = e.snapGrid.length,
                    ...
                    E = 0;
                if (void 0 !== i) {
                    "string" == typeof w && w.indexOf("%") >= 0 && (w = (parseFloat(w.replace("%", "")) / 100) * i), (e.virtualSize = -w), r ? l.css({ marginLeft: "", marginTop: "" }) : l.css({ marginRight: "", marginBottom: "" });
                    var C;
                    t.slidesPerColumn > 1 &&
                        ((C = Math.floor(c / t.slidesPerColumn) === c / e.params.slidesPerColumn ? c : Math.ceil(c / t.slidesPerColumn) * t.slidesPerColumn),
                    ...
                    for (var S, k = t.slidesPerColumn, M = C / k, I = Math.floor(c / t.slidesPerColumn), L = 0; L < c; L += 1) {
                        ...
                        if (t.slidesPerColumn > 1) {
                            ...
                            "column" === t.slidesPerColumnFill
                                ? ((A = L - (O = Math.floor(L / k)) * k),
                                    (O > I || (O === I && A === k - 1)) && (A += 1) >= k && ((A = 0), (O += 1)),
                                    (D = O + (A * C) / k),
                                    P.css({ "-webkit-box-ordinal-group": D, "-moz-box-ordinal-group": D, "-ms-flex-order": D, "-webkit-order": D, order: D }))
                                : (O = L - (A = Math.floor(L / M)) * M),
                                P.css("margin-" + (e.isHorizontal() ? "top" : "left"), 0 !== A && t.spaceBetween && t.spaceBetween + "px")
                            ...
                            l[L] && (l[L].swiperSlideSize = S),
                                ...
                                t.centeredSlides
                                    ? ((x = x + S / 2 + T / 2 + w),
                                        ...
                                        f.push(x))
                                    : (t.roundLengths && (x = Math.floor(x)), E % t.slidesPerGroup == 0 && d.push(x), f.push(x), (x = x + S + w)),
                                (e.virtualSize += S + w),
                                (T = S),
                                (E += 1);
                        }
                    ...
                    if (
                        (r && a && ("slide" === t.effect || "coverflow" === t.effect) && n.css({ width: e.virtualSize + t.spaceBetween + "px" }),
                            (h.flexbox && !t.setWrapperSize) || (e.isHorizontal() ? n.css({ width: e.virtualSize + t.spaceBetween + "px" }) : n.css({ height: e.virtualSize + t.spaceBetween + "px" })),
                            t.slidesPerColumn > 1 &&
                    ...
                    if (
                        (0 === d.length && (d = [0]), 0 !== t.spaceBetween && (e.isHorizontal() ? (r ? l.css({ marginLeft: w + "px" }) : l.css({ marginRight: w + "px" })) : l.css({ marginBottom: w + "px" })), t.centerInsufficientSlides)
                    ) {
                        var ee = 0;
                        if (
                    ...
                    p.extend(e, { slides: l, snapGrid: d, slidesGrid: f, slidesSizesGrid: v }),
            ...
            updateProgress: function (e) {
                ...
                var t = this,
                    ...
                    o = a,
                    l = s;
                0 === i ? ((r = 0), (a = !0), (s = !0)) : ((a = (r = (e - t.minTranslate()) / i) <= 0), (s = r >= 1)),
                    p.extend(t, { progress: r, isBeginning: a, isEnd: s }),
            ...
            updateActiveIndex: function (e) {
                ...
                if (((t = a.indexOf(i) >= 0 ? a.indexOf(i) : Math.floor(c / s.slidesPerGroup)) >= a.length && (t = a.length - 1), c !== o)) {
                    ...
                    p.extend(n, { snapIndex: t, realIndex: h, previousIndex: o, activeIndex: c }), n.emit("activeIndexChange"), n.emit("snapIndexChange"), l !== h && n.emit("realIndexChange"), n.emit("slideChange");
            ...
            w = {
                slideTo: function (e, t, n, i) {
                    ...
                    var f = -o[p];
                    if ((r.updateProgress(f), s.normalizeSlideIndex)) for (var v = 0; v < l.length; v += 1) -Math.floor(100 * f) >= Math.floor(100 * l[v]) && (a = v);
                    ...
                    return (
                        ...
                        (d && -f === r.translate) || (!d && f === r.translate)
                            ? (r.updateActiveIndex(a), s.autoHeight && r.updateAutoHeight(), r.updateSlidesClasses(), "slide" !== s.effect && r.setTranslate(f), "reset" !== m && (r.transitionStart(n, m), r.transitionEnd(n, m)), !1)
                            : (0 !== t && h.transition
                                ? (r.setTransition(t),
                                    r.setTranslate(f),
                                ...
                                : (r.setTransition(0), r.setTranslate(f), r.updateActiveIndex(a), r.updateSlidesClasses(), r.emit("beforeTransitionStart", t, i), r.transitionStart(n, m), r.transitionEnd(n, m)),
                                !0)
                    );
                },
            ...
            x = {
                ...
                loopFix: function () {
                    ...
                    i < a
                        ? ((e = r.length - 3 * a + i), (e += a), t.slideTo(e, 0, !1, !0) && 0 !== c && t.setTranslate((u ? -t.translate : t.translate) - c))
                        : (("auto" === n.slidesPerView && i >= 2 * a) || i >= r.length - a) && ((e = -r.length + i + a), (e += a), t.slideTo(e, 0, !1, !0) && 0 !== c && t.setTranslate((u ? -t.translate : t.translate) - c)),
                        (t.allowSlidePrev = s),
                        (t.allowSlideNext = o);
                },
            ...
            C = (function () {
                var e = u.navigator.userAgent,
                    t = { ios: !1, android: !1, androidChrome: !1, desktop: !1, windows: !1, iphone: !1, ipod: !1, ipad: !1, cordova: u.cordova || u.phonegap, phonegap: u.cordova || u.phonegap },
                ...
                events: {
                    attachEvents: function () {
                        ...
                        if (h.touch || (!h.pointerEvents && !h.prefixedPointerEvents)) {
                            if (h.touch) {
                                var f = !("touchstart" !== o.start || !h.passiveListener || !t.passiveListeners) && { passive: !0, capture: !1 };
                                d.addEventListener(o.start, e.onTouchStart, f), d.addEventListener(o.move, e.onTouchMove, h.passiveListener ? { passive: !1, capture: p } : p), d.addEventListener(o.end, e.onTouchEnd, f);
                            }
                            ((t.simulateTouch && !C.ios && !C.android) || (t.simulateTouch && !h.touch && C.ios)) &&
                                (d.addEventListener("mousedown", e.onTouchStart, !1), l.addEventListener("mousemove", e.onTouchMove, p), l.addEventListener("mouseup", e.onTouchEnd, !1));
                    ...
                    detachEvents: function () {
                        ...
                        if (h.touch || (!h.pointerEvents && !h.prefixedPointerEvents)) {
                            if (h.touch) {
                                var u = !("onTouchStart" !== n.start || !h.passiveListener || !t.passiveListeners) && { passive: !0, capture: !1 };
                            ...
                            ((t.simulateTouch && !C.ios && !C.android) || (t.simulateTouch && !h.touch && C.ios)) &&
                                (s.removeEventListener("mousedown", e.onTouchStart, !1), l.removeEventListener("mousemove", e.onTouchMove, o), l.removeEventListener("mouseup", e.onTouchEnd, !1));
            ...
            I = (function (t) {
                function n() {
                    for (var i, r = [], a = arguments.length; a--;) r[a] = arguments[a];
                    var s, o;
                    1 === r.length && r[0].constructor && r[0].constructor === Object ? (o = r[0]) : ((s = (i = r)[0]), (o = i[1])),
                        o || (o = {}),
                        (o = p.extend({}, o)),
                        s && !o.el && (o.el = s),
                        t.call(this, o),
                        ...
                        return (
                            p.extend(l, {
                                ...
                                touchEvents: (function () {
                                    ...
                                    return (
                                        h.pointerEvents ? (t = ["pointerdown", "pointermove", "pointerup"]) : h.prefixedPointerEvents && (t = ["MSPointerDown", "MSPointerMove", "MSPointerUp"]),
                    ...
                    (n.prototype.changeDirection = function (e, t) {
                        ...
                        return (
                            ...
                            e === i || ("horizontal" !== e && "vertical" !== e)
                                ? n
                                : ("vertical" === i &&
                                    (n.$el.removeClass(n.params.containerModifierClass + "vertical wp8-vertical").addClass("" + n.params.containerModifierClass + e),
                                        (f.isIE || f.isEdge) && (h.pointerEvents || h.prefixedPointerEvents) && n.$el.addClass(n.params.containerModifierClass + "wp8-" + e)),
                                    "horizontal" === i &&
                                    (n.$el.removeClass(n.params.containerModifierClass + "horizontal wp8-horizontal").addClass("" + n.params.containerModifierClass + e),
                                        (f.isIE || f.isEdge) && (h.pointerEvents || h.prefixedPointerEvents) && n.$el.addClass(n.params.containerModifierClass + "wp8-" + e)),
                    ...
                    (n.prototype.destroy = function (e, t) {
                        ...
                        return void 0 === n.params || n.destroyed
                            ...
                            : (n.emit("beforeDestroy"),
                                ...
                                !1 !== e && ((n.$el[0].swiper = null), n.$el.data("swiper", null), p.deleteProps(n)),
                                (n.destroyed = !0),
                                null);
                    }),
            ...
            L = { name: "device", proto: { device: C }, static: { device: C } },
            P = { name: "support", proto: { support: h }, static: { support: h } },
            D = { name: "browser", proto: { browser: f }, static: { browser: f } },
            O = {
                name: "resize",
                create: function () {
                    var e = this;
            ...
            z = {
                ...
                create: function () {
                    var e = this;
                    p.extend(e, { observer: { init: A.init.bind(e), attach: A.attach.bind(e), destroy: A.destroy.bind(e), observers: [] } });
                },
                on: {
                    init: function () {
                        this.observer.init();
            ...
            N = {
                update: function (e) {
                    ...
                    if ((p.extend(n.virtual, { from: T, to: E, offset: C, slidesGrid: n.slidesGrid }), d === T && h === E && !e)) return n.slidesGrid !== v && C !== g && n.slides.css(y, C + "px"), void n.updateProgress();
                    ...
                    else for (var M = d; M <= h; M += 1) (M < T || M > E) && n.$wrapperEl.find("." + n.params.slideClass + '[data-swiper-slide-index="' + M + '"]').remove();
            ...
            H = {
                handle: function (e) {
                    ...
                    if (!(i.shiftKey || i.altKey || i.ctrlKey || i.metaKey || (l.activeElement && l.activeElement.nodeName && ("input" === l.activeElement.nodeName.toLowerCase() || "textarea" === l.activeElement.nodeName.toLowerCase())))) {
                        ...
                        t.isHorizontal()
                            ? ((37 !== r && 39 !== r) || (i.preventDefault ? i.preventDefault() : (i.returnValue = !1)), ((39 === r && !n) || (37 === r && n)) && t.slideNext(), ((37 === r && !n) || (39 === r && n)) && t.slidePrev())
                            : ((38 !== r && 40 !== r) || (i.preventDefault ? i.preventDefault() : (i.returnValue = !1)), 40 === r && t.slideNext(), 38 === r && t.slidePrev()),
                            t.emit("keyPress", r);
                    }
                },
                enable: function () {
            ...
            j = {
                ...
                create: function () {
                    var e = this;
                    p.extend(e, { keyboard: { enabled: !1, enable: H.enable.bind(e), disable: H.disable.bind(e), handle: H.handle.bind(e) } });
                },
                on: {
                    init: function () {
                        var e = this;
                ...
                init: function () {
                    ...
                    if (n.nextEl || n.prevEl) {
                        ...
                        n.nextEl && ((i = e(n.nextEl)), t.params.uniqueNavElements && "string" == typeof n.nextEl && i.length > 1 && 1 === t.$el.find(n.nextEl).length && (i = t.$el.find(n.nextEl))),
                            ...
                            p.extend(t.navigation, { $nextEl: i, nextEl: i && i[0], $prevEl: r, prevEl: r && r[0] });
                    }
                },
                destroy: function () {
                    var e = this,
            ...
            B = {
                update: function () {
                    ...
                    if (i.el && t.pagination.el && t.pagination.$el && 0 !== t.pagination.$el.length) {
                        ...
                        if (
                            (t.params.loop
                                ? ((r = Math.ceil((t.activeIndex - t.loopedSlides) / t.params.slidesPerGroup)) > a - 1 - 2 * t.loopedSlides && (r -= a - 2 * t.loopedSlides),
                                    r > o - 1 && (r -= o),
                ...
                setTranslate: function () {
                    ...
                    if (e.params.scrollbar.el && e.scrollbar.el) {
                        var t = e.scrollbar,
                            ...
                            u = r,
                            c = (a - r) * i;
                        n ? ((c = -c) > 0 ? ((u = r - c), (c = 0)) : -c + r > a && (u = a + c)) : c < 0 ? ((u = r + c), (c = 0)) : c + r > a && (u = a - c),
                            e.isHorizontal()
                                ? (h.transforms3d ? s.transform("translate3d(" + c + "px, 0, 0)") : s.transform("translateX(" + c + "px)"), (s[0].style.width = u + "px"))
                                : (h.transforms3d ? s.transform("translate3d(0px, " + c + "px, 0)") : s.transform("translateY(" + c + "px)"), (s[0].style.height = u + "px")),
                            l.hide &&
                ...
                updateSize: function () {
                    ...
                    if (e.params.scrollbar.el && e.scrollbar.el) {
                        ...
                        (r = "auto" === e.params.scrollbar.dragSize ? a * s : parseInt(e.params.scrollbar.dragSize, 10)),
                            ...
                            p.extend(t, { trackSize: a, divider: s, moveDivider: o, dragSize: r }),
                ...
                enableDraggable: function () {
                    ...
                    if (e.params.scrollbar.el) {
                        var t = e.scrollbar,
                            ...
                            r = e.params,
                            a = t.$el[0],
                            s = !(!h.passiveListener || !r.passiveListeners) && { passive: !1, capture: !1 },
                            o = !(!h.passiveListener || !r.passiveListeners) && { passive: !0, capture: !1 };
                        h.touch
                            ? (a.addEventListener(n.start, e.scrollbar.onDragStart, s), a.addEventListener(n.move, e.scrollbar.onDragMove, s), a.addEventListener(n.end, e.scrollbar.onDragEnd, o))
                            : (a.addEventListener(i.start, e.scrollbar.onDragStart, s), l.addEventListener(i.move, e.scrollbar.onDragMove, s), l.addEventListener(i.end, e.scrollbar.onDragEnd, o));
                    }
                },
                disableDraggable: function () {
                    ...
                    if (e.params.scrollbar.el) {
                        var t = e.scrollbar,
                            ...
                            o = !(!h.passiveListener || !r.passiveListeners) && { passive: !0, capture: !1 };
                        h.touch
                            ? (a.removeEventListener(n.start, e.scrollbar.onDragStart, s), a.removeEventListener(n.move, e.scrollbar.onDragMove, s), a.removeEventListener(n.end, e.scrollbar.onDragEnd, o))
                            : (a.removeEventListener(i.start, e.scrollbar.onDragStart, s), l.removeEventListener(i.move, e.scrollbar.onDragMove, s), l.removeEventListener(i.end, e.scrollbar.onDragEnd, o));
                    }
                },
                init: function () {
                    var t = this;
                    if (t.params.scrollbar.el) {
                        ...
                        0 === s.length && ((s = e('<div class="' + t.params.scrollbar.dragClass + '"></div>')), a.append(s)), p.extend(n, { $el: a, el: a[0], $dragEl: s, dragEl: s[0] }), r.draggable && n.enableDraggable();
                    }
                },
                destroy: function () {
            ...
            _ = {
                ...
                onGestureChange: function (e) {
                    ...
                    r.$imageEl &&
                        0 !== r.$imageEl.length &&
                        (h.gestures ? (i.scale = e.scale * i.currentScale) : (i.scale = (r.scaleMove / r.scaleStart) * i.currentScale),
                ...
                enable: function () {
                    ...
                    if (!t.enabled) {
                        t.enabled = !0;
                        var n = !("touchstart" !== e.touchEvents.start || !h.passiveListener || !e.params.passiveListeners) && { passive: !0, capture: !1 };
                        h.gestures
            ...
            X = {
                ...
                setTranslate: function (e, t) {
                    ...
                    if (Array.isArray(s)) for (var o = 0; o < s.length; o += 1) s[o] !== t && s[o] instanceof I && n(s[o]);
                ...
                setTransition: function (e, t) {
                    ...
                    if (Array.isArray(a)) for (i = 0; i < a.length; i += 1) a[i] !== t && a[i] instanceof I && n(a[i]);
            ...
            G = {
                init: function () {
                    ...
                    if (e.params.history) {
                        ...
                        (t.initialized = !0),
                            ...
                            (t.paths.key || t.paths.value) && (t.scrollToSlide(0, t.paths.value, e.params.runCallbacksOnInit), e.params.history.replaceState || u.addEventListener("popstate", e.history.setHistoryPopState));
                    }
                },
                destroy: function () {
                    var e = this;
                ...
                setHistory: function (e, t) {
                    ...
                    if (n.history.initialized && n.params.history.enabled) {
                        ...
                        (a && a.value === r) || (n.params.history.replaceState ? u.history.replaceState({ value: r }, null, r) : u.history.pushState({ value: r }, null, r));
                    }
                },
                slugify: function (e) {
                    return e
            ...
            J = {
                setTranslate: function () {
                    ...
                    c.shadow &&
                        (d
                            ? (0 === (t = r.find(".swiper-cube-shadow")).length && ((t = e('<div class="swiper-cube-shadow"></div>')), r.append(t)), t.css({ height: s + "px" }))
                    ...
                    for (var v = 0; v < a.length; v += 1) {
                        ...
                        var w = Math.max(Math.min(m[0].progress, 1), -1),
                            ...
                            T = 0,
                            E = 0;
                        g % 4 == 0 ? ((x = 4 * -b * u), (E = 0)) : (g - 1) % 4 == 0 ? ((x = 0), (E = 4 * -b * u)) : (g - 2) % 4 == 0 ? ((x = u + 4 * b * u), (E = u)) : (g - 3) % 4 == 0 && ((x = -u), (E = 3 * u + 4 * u * b)),
                            l && (x = -x),
                            d || ((T = x), (x = 0));
                        ...
                        if ((w <= 1 && w > -1 && ((h = 90 * g + 90 * w), l && (h = 90 * -g - 90 * w)), m.transform(C), c.slideShadows)) {
                            ...
                            0 === S.length && ((S = e('<div class="swiper-slide-shadow-' + (d ? "left" : "top") + '"></div>')), m.append(S)),
                                0 === k.length && ((k = e('<div class="swiper-slide-shadow-' + (d ? "right" : "bottom") + '"></div>')), m.append(k)),
                    ...
                    for (var t = this, n = t.slides, i = t.rtlTranslate, r = 0; r < n.length; r += 1) {
                        ...
                        if ((t.isHorizontal() ? i && (o = -o) : ((c = u), (u = 0), (l = -o), (o = 0)), (a[0].style.zIndex = -Math.abs(Math.round(s)) + n.length), t.params.flipEffect.slideShadows)) {
                            ...
                            0 === d.length && ((d = e('<div class="swiper-slide-shadow-' + (t.isHorizontal() ? "left" : "top") + '"></div>')), a.append(d)),
                                0 === p.length && ((p = e('<div class="swiper-slide-shadow-' + (t.isHorizontal() ? "right" : "bottom") + '"></div>')), a.append(p)),
                ...
                setTranslate: function () {
                    for (
                        ...
                        var m = r.eq(f),
                            ...
                            T = l ? 0 : o.stretch * y,
                            E = l ? o.stretch * y : 0;
                        Math.abs(E) < 0.001 && (E = 0), Math.abs(T) < 0.001 && (T = 0), Math.abs(x) < 0.001 && (x = 0), Math.abs(b) < 0.001 && (b = 0), Math.abs(w) < 0.001 && (w = 0);
            ...
            te = {
                init: function () {
                    ...
                    t.swiper instanceof n
                        ? ((e.thumbs.swiper = t.swiper), p.extend(e.thumbs.swiper.originalParams, { watchSlidesProgress: !0, slideToClickedSlide: !1 }), p.extend(e.thumbs.swiper.params, { watchSlidesProgress: !0, slideToClickedSlide: !1 }))
                        : p.isObject(t.swiper) && ((e.thumbs.swiper = new n(p.extend({}, t.swiper, { watchSlidesVisibility: !0, watchSlidesProgress: !0, slideToClickedSlide: !1 }))), (e.thumbs.swiperCreated = !0)),
            ...
            ne = [
                ...
                },
                {
                    ...
                    create: function () {
                        var e = this;
                        p.extend(e, { navigation: { init: q.init.bind(e), update: q.update.bind(e), destroy: q.destroy.bind(e), onNextClick: q.onNextClick.bind(e), onPrevClick: q.onPrevClick.bind(e) } });
                    },
                    on: {
                        init: function () {
                            var e = this;
                ...
                },
                {
                    ...
                    create: function () {
                        var e = this;
                        p.extend(e, { pagination: { init: B.init.bind(e), render: B.render.bind(e), update: B.update.bind(e), destroy: B.destroy.bind(e), dynamicBulletIndex: 0 } });
                    },
                    on: {
                        init: function () {
                            var e = this;
                        ...
                        click: function (t) {
                            ...
                            n.params.pagination.el &&
                                ...
                                !e(t.target).hasClass(n.params.pagination.bulletClass) &&
                ...
                },
                {
                    ...
                    create: function () {
                        var e = this;
                        p.extend(e, { parallax: { setTransform: R.setTransform.bind(e), setTranslate: R.setTranslate.bind(e), setTransition: R.setTransition.bind(e) } });
                    },
                    on: {
                        beforeInit: function () {
                            var e = this;
                ...
                },
                {
                    ...
                    create: function () {
                        var e = this;
                        p.extend(e, { lazy: { initialImageLoaded: !1, load: W.load.bind(e), loadInSlide: W.loadInSlide.bind(e) } });
                    },
                    on: {
                        beforeInit: function () {
                            var e = this;
                ...
                },
                {
                    ...
                    create: function () {
                        var e = this;
                        p.extend(e, { controller: { control: e.params.controller.control, getInterpolateFunction: X.getInterpolateFunction.bind(e), setTranslate: X.setTranslate.bind(e), setTransition: X.setTransition.bind(e) } });
                    },
                    on: {
                        update: function () {
                            var e = this;
                ...
                },
                {
                    ...
                    create: function () {
                        var t = this;
                        p.extend(t, { a11y: { liveRegion: e('<span class="' + t.params.a11y.notificationClass + '" aria-live="assertive" aria-atomic="true"></span>') } }),
                ...
                },
                {
                    ...
                    create: function () {
                        var e = this;
                        p.extend(e, { history: { init: G.init.bind(e), setHistory: G.setHistory.bind(e), setHistoryPopState: G.setHistoryPopState.bind(e), scrollToSlide: G.scrollToSlide.bind(e), destroy: G.destroy.bind(e) } });
                    },
                    on: {
                        init: function () {
                            var e = this;
                ...
                },
                {
                    ...
                    create: function () {
                        var e = this;
                        p.extend(e, { hashNavigation: { initialized: !1, init: U.init.bind(e), destroy: U.destroy.bind(e), setHash: U.setHash.bind(e), onHashCange: U.onHashCange.bind(e) } });
                    },
                    on: {
                        init: function () {
                            var e = this;
                ...
                },
                {
                    ...
                    create: function () {
                        var e = this;
                        p.extend(e, { fadeEffect: { setTranslate: K.setTranslate.bind(e), setTransition: K.setTransition.bind(e) } });
                    },
                    on: {
                        beforeInit: function () {
                            var e = this;
                ...
                },
                {
                    ...
                    create: function () {
                        var e = this;
                        p.extend(e, { cubeEffect: { setTranslate: J.setTranslate.bind(e), setTransition: J.setTransition.bind(e) } });
                    },
                    on: {
                        beforeInit: function () {
                            var e = this;
                ...
                },
                {
                    ...
                    create: function () {
                        var e = this;
                        p.extend(e, { flipEffect: { setTranslate: Z.setTranslate.bind(e), setTransition: Z.setTransition.bind(e) } });
                    },
                    on: {
                        beforeInit: function () {
                            var e = this;
                ...
                },
                {
                    ...
                    create: function () {
                        var e = this;
                        p.extend(e, { coverflowEffect: { setTranslate: ee.setTranslate.bind(e), setTransition: ee.setTransition.bind(e) } });
                    },
                    on: {
                        beforeInit: function () {
                            var e = this;
                ...
                },
                {
                    ...
                    create: function () {
                        var e = this;
                        p.extend(e, { thumbs: { swiper: null, init: te.init.bind(e), update: te.update.bind(e), onThumbClick: te.onThumbClick.bind(e) } });
                    },
                    on: {
                        beforeInit: function () {
                            var e = this,
    ...
    (function (e, t) {
        "object" == typeof exports && "object" == typeof module
            ? (module.exports = t())
            : "function" == typeof define && define.amd
                ? define("scrollMonitor", [], t)
                : "object" == typeof exports
                    ? (exports.scrollMonitor = t())
                    : (e.scrollMonitor = t());
    })(this, function () {
        return (function (e) {
            function t(i) {
                            ...
                            (e.prototype.listenToDOM = function () {
                                u &&
                                    (window.addEventListener
                                        ? (this.item === document.body ? window.addEventListener("scroll", this.DOMListener, f) : this.item.addEventListener("scroll", this.DOMListener, f),
                                        ...
                                        (this.destroy = function () {
                                            window.addEventListener
                                                ? (this.item === document.body ? (window.removeEventListener("scroll", this.DOMListener, f), this.containerWatcher.destroy()) : this.item.removeEventListener("scroll", this.DOMListener, f),
            ...
            function (e, t, n) {
                ...
                function i(e, t, n) {
                    function i(e, t) {
                        if (0 !== e.length) for (w = e.length; w--;) (x = e[w]).callback.call(r, t, r), x.isOne && e.splice(w, 1);
                    }
                    var r = this;
                    (this.watchItem = t), (this.container = e), (this.offsets = n ? (n === +n ? { top: n, bottom: n } : { top: n.top || h.top, bottom: n.bottom || h.bottom }) : h), (this.callbacks = {});
                    for (var f = 0, v = p.length; f < v; f++) r.callbacks[p[f]] = [];
                    this.locked = !1;
                    var m, g, y, b, w, x;
                    (this.triggerCallbacks = function (e) {
                        switch (
                        (this.isInViewport && !m && i(this.callbacks[s], e),
                            this.isFullyInViewport && !g && i(this.callbacks[o], e),
                            this.isAboveViewport !== y &&
                            this.isBelowViewport !== b &&
                            (i(this.callbacks[a], e), g || this.isFullyInViewport || (i(this.callbacks[o], e), i(this.callbacks[u], e)), m || this.isInViewport || (i(this.callbacks[s], e), i(this.callbacks[l], e))),
                    ...
                    if (((d = document.documentElement.clientWidth), void 0 === c)) {
                        ...
                        t &&
                            ...
                            ((c = document.body.style.paddingRight),
                                ...
                                $("#curtain, #nav,header#header,#nav-overlay-content .content,.loader,.scroll-container .scroll-wrapper.on,section.case-study-next-project,.document-overlay,.loader-preloader,#nav footer").css(
                                    "width",
                                    "calc(100% - " + n + "px)"
                                ),
                                $("a.scroll-top").css("margin-right", n + "px"),
                                -1 != navigator.userAgent.indexOf("Safari") && -1 == navigator.userAgent.indexOf("Chrome") && 0 == p && (mediaQueriesHelper.init(document.documentElement.clientWidth - d), (p = !0)));
                    }
        ...
        (e.disableBodyScroll = function (e, i) {
            r
                ...
                ((s = [].concat(t(s), [e])),
                    ...
                    o || (document.addEventListener("touchmove", h, n ? { passive: !1 } : void 0), (o = !0)))
                : (f(i), a || (a = e));
        }),
            (e.clearAllBodyScrollLocks = function () {
                r
                    ? (s.forEach(function (e) {
                        ...
                        o && (document.removeEventListener("touchmove", h, n ? { passive: !1 } : void 0), (o = !1)),
                        (s = []),
                        (l = -1))
                    : (v(), (a = null));
            }),
            (e.enableBodyScroll = function (e) {
                r
                    ? ((e.ontouchstart = null),
                        ...
                        o && 0 === s.length && (document.removeEventListener("touchmove", h, n ? { passive: !1 } : void 0), (o = !1)))
                    : a === e && (v(), (a = null));
            });
    });
